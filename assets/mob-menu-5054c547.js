        ...
        <div class="workout-box" id=${s._id}>
          ...
          <div class="workout-description">
              ...
              <p class="description-item-name">Target:
                ...
                </li>`;h.innerHTML=g,m=k*p,b=m-p,S(s.slice(b,m)),window.scrollBy({top:700,behavior:"smooth"})}else S(s)}})}const se=()=>{if(window.innerWidth<768&&O(h),window.innerWidth<768){g="",h.innerHTML="",L=Math.ceil(v.length/p);for(let e=1;e<=L;e++)e===1?g+=`
          <li>
